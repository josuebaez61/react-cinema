                ...
                <div className="p-grid h-100">
                                ...
                                <ul className="p-p-0 p-pl-md-2">
                                    {
                                        navItems.map(item =>
                                        (
                                            <li key={ item.title } className="p-text-center p-text-md-left">
                                                <Link to={item.url}>
                                                    {item.title}
                                                </Link>
                                            </li>
                    ...
                    <div className="p-col-6 p-md-2 p-d-flex p-flex-column p-ai-center p-ai-md-start p-jc-evenly h-100 app-footer__site-map">
                        ...
                        <div>
                            ...
                            <ul className="p-p-0 p-pl-md-2">
                                <li>
                                    <a rel="noreferrer" target="_blank" href="http://www.linkedin.com/in/josuebaez15">
                                        LinkedIn
                                    </a>
                                </li>
                                <li>
                                    <a rel="noreferrer" target="_blank" href="https://www.facebook.com/josueDev61">
                                        Facebook
                                    </a>
                                </li>
                                <li>
                                    <a rel="noreferrer" target="_blank" href="https://www.instagram.com/josuebaez61/">
                                        Instagram
                                    </a>
                                </li>
                            </ul>
